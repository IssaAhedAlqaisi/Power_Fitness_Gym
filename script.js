...
const translations = {
  ar: {
    logo_main: "باور فيتنس جيم",
    logo_sub: "Power Fitness Gym",
    ...
    facilities_title: "مرافق باور فيتنس جيم",
    facilities_subtitle:
    ...
    stories_subtitle:
      "حكايات من أجواء باور فيتنس جيم ونصائح تساعدك تبدأ وتستمر.",
    stories_sub_title: "قصص من أعضائنا",
    story_1_title: "من التعب على الدرج إلى تمرين كامل",
    story_1_text:
      "أحمد كان يتعب من طلعة درج واحدة ويتجنب أي نشاط رياضي. بعد ٦ أشهر في باور فيتنس جيم بين المسبح وتمارين الحديد، صار يخلص تمرين كامل بدون ما يحس بنفس التعب وخسر ١٢ كيلو بطريقة صحية.",
    story_2_title: "ثقة جديدة مع كل تمرين",
    story_2_text:
      "روان كانت مترددة تبدأ في الجيم. مع الوقت والتدرج، قدرت تلتزم ٣ مرات أسبوعياً، لاحظت فرق في نومها وطاقة يومها قبل ما تشوف الفرق على الميزان. اليوم الرياضة جزء ثابت من روتينها في باور فيتنس جيم.",

    tips_title: "نصائح من باور فيتنس جيم",
  ...
  en: {
    ...
    story_1_text:
      "Ahmad used to get exhausted from just one flight of stairs and avoided any activity. After 6 months at Power Fitness Gym combining swimming and weights, he can now finish a full workout with ease and has lost 12 kg in a healthy way.",
    story_2_title: "New confidence with every session",
    story_2_text:
      "Rawan was hesitant to start at the gym. With time and gradual progress, she committed to training three times a week. She noticed better sleep and energy before she even saw changes on the scale. Today, training at Power Fitness Gym is a fixed part of her routine.",

    tips_title: "Tips from Power Fitness Gym",
